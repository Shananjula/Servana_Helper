...
//
// Helper Wallet (Map v2.2)
// - Reads coins from users/{uid}.servCoinBalance
// - Reads transactions from users/{uid}/transactions
// - Highlights: accept_fee (public offers), refunds/releases, topups
// - Shows hint: public offer acceptance may cost 25 coins; direct invites cost the poster, not you.
//
                    ...
                    if (docs.isEmpty) {
                      return const _EmptyState(
                        ...
                        subtitle: 'When a poster accepts your public offer, 25 coins may be charged.\n'
                                  'If it was a direct invite, no coins are charged to you.',
                      );
                    }
